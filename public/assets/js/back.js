...
$( document ).on( 'keydown', function ( e ) {
    if(e.keyCode===191&&!$("#header_search").is(":focus"))
    {
        e.preventDefault();
...
function tinymceInit(selector='textarea', inline=false, folder=null)
{
    ...
    tinymce.init({
        ...
        toolbar: 'undo redo | styleselect  fontselect fontsizeselect  forecolor backcolor | alignleft aligncenter alignright bullist numlist outdent indent code bold italic blockquote | link image preview media table',

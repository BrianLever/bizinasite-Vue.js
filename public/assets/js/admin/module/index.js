...
$(document).on("click", ".getModule", function() {
    ...
    askToast.question("Confirm", "Do you want to get this module?", "getModule")
});
...
$(document).on("click", ".switchModule", function() {
    ...
    {
        message = "Do you want to cancel this module? We will keep your data for 1 month. This means, if you get this module back in 1 month, you will get all data as same. But after 1 month, your data will be lost."
    }

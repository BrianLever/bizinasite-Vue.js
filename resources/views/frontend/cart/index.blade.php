        ...
        <div class="row my-5">
            ...
            <div class="col-12">
                <div class="text-right">
                    <button type="submit" class="btn btn-success btn-sm updateCrtBtn">Update Cart</button>
                    <a href="javascript:void(0);" class="btn btn-primary btn-sm">Continue Shopping</a>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group maxw-300">
                            ...
                            <a href="" class="btn btn-success btn-sm">Apply Coupon</a>
                        </div>
                    </div>

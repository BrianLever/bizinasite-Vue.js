...
class DirectoryController extends Controller
{
    ...
    public function category($slug)
    {
        ...
        return view('frontend.directory.category', compact("category", "seo"));
    }
    public function subCategory($cat_slug, $subCat_slug)
    {
        ...
        return view('frontend.directory.subCategory', compact("category", "seo"));
    }
    public function tag($slug)
    {
        ...
        return view('frontend.directory.tag', compact("tag", "seo"));
    }
    public function detail($slug)
    {
        ...
        return view('frontend.directory.detail', compact("listing", "seo"));
    }
    ...
    public function package(Request $request)
    {
        ...
        return view('frontend.directory.package', compact("seo"));
    }
    public function packageDetail($slug)
    {
        ...
        return view('frontend.directory.packageDetail', compact('item', 'seo'));
    }

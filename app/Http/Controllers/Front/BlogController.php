...
//            Session::put($blogKey,1);
        ...
        return view("frontend.blog.{$this->template}.detail", compact("post", "randomposts", "seo"));
    }
    public function category($slug)
    {
        ...
        return view("frontend.blog.{$this->template}.category", compact("category", "seo"));
    }
    ...
    public function tag($slug)
    {
        ...
        return view("frontend.blog.{$this->template}.tag", compact("tag", "seo"));
    }
    public function allPosts(Request $request)
    {
        ...
        return view("frontend.blog.{$this->template}.allPosts", compact("categories", "seo"));
    }
    ...
    public function package(Request $request)
    {
        ...
        if($setting['permission'] !='paid'&&$setting['permission'] !='both') abort(404);
